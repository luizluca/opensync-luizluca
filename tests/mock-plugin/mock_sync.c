...
static void mock_finalize(OSyncPlugin *plugin, void *data)
{
	mock_env *env = data;
...
static osync_bool mock_discover(OSyncPlugin *plugin, OSyncPluginInfo *info, void *data, OSyncError **error)
{
