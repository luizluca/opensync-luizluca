...
static osync_bool discover(OSyncPluginInfo *info, void *userdata, OSyncError **error)
{
	...
	osync_version_set_plugin(version, "simple-plugin-static-caps");
	//osync_version_set_modelversion(version, "modelversion");
...
osync_bool get_sync_info(OSyncPluginEnv *env, OSyncError **error)
{
	...
	osync_plugin_set_name(plugin, "simple-plugin-static-caps");
